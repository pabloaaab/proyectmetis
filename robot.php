...
WHERE FROM_UNIXTIME(x2_list_items.sent,'%Y-%m-%d %H:%i:%s') LIKE '%$fecha%'
...
while ($obj = mysqli_fetch_object($resultado)) {
    ...
    $cliente = "select id_cliente,placa from cliente where placa = '$obj->placa' ";
    ...
    if ($reg == 0){ //insercion
        ...
        $editcliente = "update cliente set nombre_id = '$obj->nombre_completo', nombres = '$obj->nombres', apellidos = '$obj->apellidos', nombre_completo = '$obj->nombre_completo', telefono_1 = '$obj->telefono_1', telefono_2 = '$obj->telefono_2', email = '$obj->email', pagina = '$obj->pagina', direccion_1 = '$obj->direccion_1', direccion_2 = '$obj->direccion_2', ciudad = '$obj->ciudad', departamento = '$obj->departamento', pais = '$obj->pais '"
                . " where placa = '$datos->placa'";
        $resuult = mysqli_query($enlace2, $editcliente) or die ("error consulta edicion cliente $editcliente");
